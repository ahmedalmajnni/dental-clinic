...
@else
<table>
  <thead><tr><th>Name</th><th>Job title</th><th>Specialty</th><th>Branch</th><th>Phone</th><th></th></tr></thead>
  <tbody>
    @foreach($employees as $e)
      <tr>
        ...
        <td>{{ $e->phone ?: '—' }}</td>
        <td class="actions">
          <a href="{{ route('employees.edit', $e) }}" class="btn small secondary edit-action">Edit</a>
