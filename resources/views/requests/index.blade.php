...
@if($requests->isEmpty())
  <div class="card"><p class="muted">No appointment requests yet.</p></div>
@else
<table>
  <thead><tr><th>Requested</th><th>Patient</th><th>Doctor</th><th>Branch</th><th>Preferred</th><th>Status</th><th></th></tr></thead>
  <tbody>
