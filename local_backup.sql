...
\restrict CnwmPkO2C7xJOGYGW1bezJ5jI4xFKwvmSv3ecs1PFcpG44WeJdHCk2spCZ662ip
...
CREATE TABLE public.account (
    ...
    CONSTRAINT account_role_check CHECK (((role)::text = ANY (ARRAY[('admin'::character varying)::text, ('employee'::character varying)::text, ('patient'::character varying)::text])))
);
...
CREATE TABLE public.appointment (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT appointment_status_check CHECK (((status)::text = ANY (ARRAY[('booked'::character varying)::text, ('completed'::character varying)::text, ('cancelled'::character varying)::text, ('no_show'::character varying)::text])))
);
...
--
-- Name: TABLE appointment; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: appointment_request; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE public.appointment_request (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT appointment_request_status_check CHECK (((status)::text = ANY (ARRAY[('pending'::character varying)::text, ('scheduled'::character varying)::text, ('declined'::character varying)::text, ('cancelled'::character varying)::text])))
);


ALTER TABLE public.appointment_request OWNER TO postgres;
...
CREATE TABLE public.branch (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT branch_type_check CHECK (((type)::text = ANY (ARRAY[('clinic'::character varying)::text, ('studio'::character varying)::text])))
);
...
CREATE TABLE public.employee (
    ...
    phone character varying(30),
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT employee_job_title_check CHECK (((job_title)::text = ANY (ARRAY[('admin'::character varying)::text, ('doctor'::character varying)::text, ('reception'::character varying)::text, ('lab_tech'::character varying)::text])))
);
...
CREATE TABLE public.invoice (
    ...
    CONSTRAINT invoice_status_check CHECK (((status)::text = ANY (ARRAY[('open'::character varying)::text, ('partial'::character varying)::text, ('paid'::character varying)::text, ('void'::character varying)::text]))),
...
--
-- Name: TABLE invoice_line; Type: COMMENT; Schema: public; Owner: postgres
--
...
--
-- Name: lab_case; Type: TABLE; Schema: public; Owner: postgres
--
...
CREATE TABLE public.lab_case (
    ...
    CONSTRAINT lab_case_status_check CHECK (((status)::text = ANY (ARRAY[('received'::character varying)::text, ('in_progress'::character varying)::text, ('ready'::character varying)::text, ('delivered'::character varying)::text, ('cancelled'::character varying)::text])))
);


ALTER TABLE public.lab_case OWNER TO postgres;

--
-- Name: TABLE lab_case; Type: COMMENT; Schema: public; Owner: postgres
--
...
CREATE TABLE public.media (
    ...
    created_at timestamp with time zone DEFAULT now() NOT NULL,
    CONSTRAINT media_type_check CHECK (((type)::text = ANY (ARRAY[('xray'::character varying)::text, ('scan'::character varying)::text, ('photo'::character varying)::text])))
);
...
CREATE TABLE public.payment (
    ...
    CONSTRAINT payment_method_check CHECK (((method)::text = ANY (ARRAY[('cash'::character varying)::text, ('card'::character varying)::text, ('transfer'::character varying)::text, ('other'::character varying)::text])))
);
...
--
-- Name: TABLE payment_allocation; Type: COMMENT; Schema: public; Owner: postgres
--
...
CREATE TABLE public.treatment (
    ...
    CONSTRAINT treatment_status_check CHECK (((status)::text = ANY (ARRAY[('planned'::character varying)::text, ('done'::character varying)::text, ('cancelled'::character varying)::text])))
);
...
019f855b-ecdc-715b-aaa4-1e78ebc8675a	admin@clinic.local	$2y$12$krhkibZZkteps8x1jSxHRu9X8m6ShiDAuoMNx6Oyc1JtNN6eKb5AW	admin	019f855b-ebd9-726b-a24f-794e7f8c8690	\N	t	2026-09-05 18:47:51+03	2026-07-21 18:47:01.69696+03
\.
...
01a07302-3b50-7015-8324-35f737f01862	019f855b-ef81-7206-a3a4-e1799aef242b	019f855b-ef71-7374-b7ec-0020ea1df76c	019f855b-ebd3-7096-85ff-d1a505bc8553	2026-09-05 22:17:00+03	booked	2026-09-05 22:18:41.244717+03
\.


--
-- Data for Name: appointment_request; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Data for Name: lab_case; Type: TABLE DATA; Schema: public; Owner: postgres
--
...
--
-- Name: appointment_request appointment_request_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: lab_case lab_case_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: idx_account_employee; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_account_patient; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_alloc_invoice; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_appt_branch; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_appt_doctor; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_appt_patient; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_appt_schedule; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_apptreq_patient; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_apptreq_status; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_labcase_doctor; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_labcase_patient; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_line_invoice; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_line_treatment; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_media_branch; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_media_patient; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_report_appt; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_report_patient; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_treatment_appt; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: idx_treatment_patient; Type: INDEX; Schema: public; Owner: postgres
--
...
--
-- Name: account account_patient_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: appointment_request appointment_request_appointment_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: appointment_request appointment_request_branch_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: appointment_request appointment_request_doctor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: appointment_request appointment_request_patient_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: appointment_request appointment_request_processed_by_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: invoice_line invoice_line_treatment_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: lab_case lab_case_doctor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: lab_case lab_case_patient_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: media media_branch_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: report report_doctor_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: report report_patient_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: treatment treatment_appointment_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
--
-- Name: treatment treatment_patient_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--
...
\unrestrict CnwmPkO2C7xJOGYGW1bezJ5jI4xFKwvmSv3ecs1PFcpG44WeJdHCk2spCZ662ip
